...
class Config:
    '''
    Config class to serve as a container and obejct for CodeReader configurations
    ...
    def __init__(self, fn=None, config={}):
        '''
        Will initialize the Config object with a given config, if given one. Otherwise it will default to just the default
        configuration file. 
        Will try to load the defaultly named config file if it exists. Otherwise, it will merely have the default configurations.
        '''
    ...
    def set(self, param, value):
        '''
        Just sets the value for the parameter to the value, regardless of whether or not it currently exists
